...
class TemplateTests: XCTestCase {
    ...
    func testTemplateElementAsCode() {
        ...
        XCTAssertEqual(TemplateElement.Literal(text:"abcd").asCode, "r.write(\"abcd\")")

        XCTAssertEqual(TemplateElement.Literal(text:"<a href=\"/\">Back</a>").asCode, "r.write(\"<a href=\\\"/\\\">Back</a>\")")
