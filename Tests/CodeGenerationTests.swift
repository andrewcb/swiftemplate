...
class CodeGenerationTests: XCTestCase {
    ...
    func testTemplateElementAsCode() {
        ...
        XCTAssertEqual(TemplateElement.Literal(text:"abcd").asCode, "_ℜ.append(\"abcd\")")
        
        XCTAssertEqual(TemplateElement.Literal(text:"<a href=\"/\">Back</a>").asCode, "_ℜ.append(\"<a href=\\\"/\\\">Back</a>\")")
        
        
        XCTAssertEqual(TemplateElement.Code(code:"if i<0 {").asCode, "if i<0 {")
        
        XCTAssertEqual(TemplateElement.Expression(code:"2+3").asCode, "_ℜ.append(String(2+3))")
        XCTAssertEqual(TemplateElement.Expression(code:"\"abc\".characters.count").asCode, "_ℜ.append(String(\"abc\".characters.count))")
    }
